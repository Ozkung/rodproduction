<template>
  ...
  >
    ...
    <div class="my-4 detailContact">
      <div>
        เรารับผลิตสื่อครอบคลุมทุกรูปแบบ
        พร้อมตอบสนองความต้องการตั้งแต่ขั้นตอนการเตรียมงาน คิด ค้น ไอเดียสดใหม่
        (Pre-Production), ถ่ายทำด้วยอุปกรณ์และทีมงานผู้เชี่ยวชาญ (Production), และตัดต่อให้โดน ๆ
        ปัง ๆ (Post-Production) ด้วยทีมงานมืออาชีพในทุกขั้นตอน ที่พร้อมให้คำปรึกษาระดมความคิด เพื่อสร้าง
